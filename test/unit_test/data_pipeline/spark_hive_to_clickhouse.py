...
spark-submit --master yarn \
 ...
 spark-submit --master yarn     --deploy-mode client     --driver-memory 512m     --executor-memory 1g     --executor-cores 1     --num-executors 1     --conf "spark.executor.memoryOverhead=512"     --conf "spark.executor.memoryOverhead=256"     --conf spark.hadoop.yarn.log-aggregation.wait.ms=60000     --conf spark.eventLog.enabled=true     --conf spark.eventLog.dir=hdfs:///spark-logs     --packages com.clickhouse.spark:clickhouse-spark-runtime-3.3_2.12:0.8.0,com.clickhouse:clickhouse-client:0.6.3,com.clickhouse:clickhouse-http-client:0.6.3,org.apache.httpcomponents.client5:httpclient5:5.2.1    /opt/miniconda3/envs/pyspark_env/jobs_sync/Users/smars/Developer/big-data-engineering-project1/test/unit_test/data_pipeline/spark_hive_to_clickhouse.py
