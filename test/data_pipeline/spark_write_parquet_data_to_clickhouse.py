...
make sure we have those jars under $SPARK_HOME/jars:
    com.clickhouse.spark_clickhouse-spark-runtime-3.3_2.12-0.8.0.jar,
    com.clickhouse_clickhouse-client-0.6.3.jar,
    com.clickhouse_clickhouse-http-client-0.6.3.jar,
    org.apache.httpcomponents.client5_httpclient5-5.2.1.jar,
    com.clickhouse_clickhouse-data-0.6.3.jar,
    org.apache.httpcomponents.core5_httpcore5-5.2.jar,
    org.apache.httpcomponents.core5_httpcore5-h2-5.2.jar,
...
spark-submit --master yarn \
    ...
    /opt/miniconda3/envs/pyspark_env/jobs_sync/Users/smars/Developer/big-data-engineering-project1/test/unit_test/data_pipeline/spark_write_parquet_data_to_clickhouse.py
